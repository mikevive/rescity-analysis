...
from application.services.dtos.exceptions.exceptions import InvalidEquationError, InvalidIdError, LongitudeEquationError, LongitudeNameError, LongitudeUnitsError

class KpiUpdateDto():

  def __init__(self, id: str, name: str, equation: str, units: str) -> None:
    try:
      ObjectId(id)
    except InvalidId:
